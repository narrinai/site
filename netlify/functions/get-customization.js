...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const customizationUrl = `https://api.airtable.com/v0/${AIRTABLE_BASE_ID}/ChatHistory?filterByFormula=AND({User}='${userRecordId}',{Role}='customization',FIND('${character_slug}',{Summary})>0)&maxRecords=1`;
