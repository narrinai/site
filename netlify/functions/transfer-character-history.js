exports.handler = async (event, context) => {
  ...
  try {
    ...
    try {
      ...
      // Skip memories transfer if table doesn't exist
      console.log('⚠️ Skipping memories transfer - table may not exist or have different permissions');
      
      /* Commented out for now due to permissions issue
